    ...
    <form class='auto-tag-settings'>
        <div class='settings-grid'>
            <fieldset>
                ...
                <div class='checks'>
                    <label class='inline'><input type='checkbox' data-cfg='typeTags.enabled' data-type='bool'/><span class='checkbox'>Enabled</span></label>
                    <label class='inline'><input type='checkbox' data-cfg='typeTags.applyOnUpload' data-type='bool'/><span class='checkbox'>Apply on upload</span></label>
                </div>
            ...
            <fieldset class='wide'>
                ...
                <div class='checks'>
                    <label class='inline'><input type='checkbox' data-cfg='hash.enabled' data-type='bool'/><span class='checkbox'>Enabled</span></label>
                    <label class='inline'><input type='checkbox' data-cfg='hash.applySafety' data-type='bool'/><span class='checkbox'>Set safety from rating</span></label>
                    <label class='inline'><input type='checkbox' data-cfg='hash.safetyOnlyIfUnset' data-type='bool'/><span class='checkbox'>…only when still Safe</span></label>
                    <label class='inline'><input type='checkbox' data-cfg='hash.recategorizeExisting' data-type='bool'/><span class='checkbox'>Recategorize existing tags</span></label>
                </div>
                ...
                <div class='sources'>
                    ...
                    <div class='source-cards'>
                        <div class='source'>
                            <label class='inline'><input type='checkbox' data-cfg='hash.sources.rule34.enabled' data-type='bool'/><span class='checkbox'>rule34.xxx</span></label>
                        ...
                        <div class='source'>
                            <label class='inline'><input type='checkbox' data-cfg='hash.sources.danbooru.enabled' data-type='bool'/><span class='checkbox'>danbooru.donmai.us</span></label>
                        ...
                        <div class='source'>
                            <label class='inline'><input type='checkbox' data-cfg='hash.sources.gelbooru.enabled' data-type='bool'/><span class='checkbox'>gelbooru.com</span></label>
            ...
            <fieldset>
                ...
                <div class='checks'>
                    <label class='inline'><input type='checkbox' data-cfg='ai.enabled' data-type='bool'/><span class='checkbox'>Enabled</span></label>
                </div>
